<?php
  ...
  call_user_func(function () {
      $GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['slidecontent'] =  'mimetypes-x-content-slidecontent';
    ...
    $GLOBALS['TCA']['tt_content']['columns']['tx_slidecontent_template'] = [
        'exclude' => 1,
        'label'   => 'Template',
        'config'  => array(
            'type'     => 'select',
    ...
    $GLOBALS['TCA']['tt_content']['columns']['tx_slidecontent_cropratio'] = [
        'exclude' => 1,
        'label'   => 'Image Crop',
        'config'  => array(
            'type'     => 'select',
    ...
    $GLOBALS['TCA']['tt_content']['columns']['tx_slidecontent_link'] = [
        'exclude' => true,
        'label' => 'Link',
        'config' => [
            'type' => 'input',
    ...
    $GLOBALS['TCA']['tt_content']['columns']['tx_slidecontent_linktext'] = [
    ...
    $GLOBALS['TCA']['tt_content']['types']['slidecontent'] = array(
       'showitem' => '
             --palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xml:palette.general;general,
             --palette--;Content;slidecontentSettings,
                    ...
                    'overrideChildTca' => [
                        'types' => [
                            ...
                            \TYPO3\CMS\Core\Resource\File::FILETYPE_IMAGE => [
                                'showitem' => '
                                    tx_slidecontent_bgplacement,alternative,crop,
                                    --palette--;;filePalette'
                            ],
                        ],
                        'columns' => [
    ...
    $GLOBALS['TCA']['tt_content']['palettes']['slidecontentSettings']['showitem'] = '
        --linebreak--,header,
        --linebreak--,subheader,
        --linebreak--,bodytext,
        --linebreak--,tx_slidecontent_link,tx_slidecontent_linktext,
        --linebreak--,tx_slidecontent_template,tx_slidecontent_cropratio,
        --linebreak--,assets,
    ';
